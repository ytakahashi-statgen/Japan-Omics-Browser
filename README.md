...
The Japan Omics Browser (JOB) is an integrated web application for visualizing and analyzing integrative omics data. It provides interactive plots and visualizations for various datasets, including gene expression and transcription factor binding. The application is hosted on the Google Cloud Platform.

### Usage
To use JOB, simply visit : https://optical-hexagon-384504.an.r.appspot.com/
